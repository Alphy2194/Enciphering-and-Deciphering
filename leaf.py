...
from tensopip install tensorflowrflow.keras.preprocessing.image import load_img
...
def predict():
    if request.method == 'POST':
        ...
        file_path = os.path.join(
            'C:/Users/Madhuri/AppData/Local/Programs/Python/Python38/Tomato_Leaf_Disease_Prediction/static/upload/',
            filename)
        file.save(file_path)
